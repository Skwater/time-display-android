...
已创建可导入 Android Studio 的原生 Java 项目。当前版本为 0.5.0，Debug APK 位于 `releases/time-display-0.5.0-debug.apk`。此前打包版本已由用户在设备上完成验收；0.5.0 已构建并核对签名，尚待设备验收，步骤见[测试计划](docs/test-plan.md)。
