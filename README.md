...
已创建可导入 Android Studio 的原生 Java 项目。当前版本为 0.8.0，Debug APK 位于 `releases/time-display-0.8.0-debug.apk`。构建和签名已核对；此前已打包版本由用户在设备上完成验收，本版设备验收尚未记录，步骤见[测试计划](docs/test-plan.md)。
